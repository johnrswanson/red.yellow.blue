...
if(isset($editalbum))
	...
	while($info=mysql_fetch_array($data))
		...
		echo'<table><tr><td valign="top"><img src="../img/album/'.$info['photo'].'" width="200px"><P>';
		...
		$data2=mysql_query("select * from pages where ID!='$albumID' AND page_type='10' order by title ASC");
