...
echo'<table><tr><td valign="top">Video Thumbnail:<br><img src="../img/video/'.$userID.'/'.$info['photo'].'" width="200px"><br>';
echo $text;
...
echo' Video Embed Code : <br><textarea name="text" rows="20" cols="30">'.$text.'</textarea><P>';


$data2=mysql_query("select * from pages where ID!='$playlist' AND page_type='4' and adminID='$userID' order by title ASC");
