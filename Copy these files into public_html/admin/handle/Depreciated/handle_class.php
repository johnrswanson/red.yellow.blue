...
while($info=mysql_fetch_array($data))
	...
	echo'<table><tr><td valign="top"><img src="../img/class/'.$userID.'/'.$info['photo'].'" width="300px"><P>';
	...
	<P>';
	$data2=mysql_query("select * from pages where ID!='$classID' AND page_type='3' and adminID='$userID'  order by title ASC");
