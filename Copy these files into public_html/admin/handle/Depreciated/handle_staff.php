...
while($info=mysql_fetch_array($data))
	...
	echo'<table><tr><td valign="top"><img src="../img/staff/'.$userID.'/'.$info['photo'].'" width="200px"><P>';
	...
	$data2=mysql_query("select * from pages where ID!='$staffID' AND page_type='3' and adminID='$userID'  order by title ASC");
